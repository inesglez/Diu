...
public class Botones extends Application {
    ...
    public void start(Stage escenarioPrincipal) {
        try {
            ...
            Image imagen = new Image("file:resources/imagenes/iconoCerveza.png", 30, 30, true, true);
            ...
            imagen = new Image("file:resources/imagenes/iconoApagar.png", 30, 30, true, true);
